...
function startServer() {
    var websocket = new Server_1.Server(PORT, PROJECT_PATH, CREATOR_USER_NAME, REMOTE_BUCKET_NAME, REMOTE_BUCKET_PREFIX);
...
var _a = process.env, KOJI_ORIGIN_REMOTE = _a.KOJI_ORIGIN_REMOTE, KOJI_UPSTREAM_REMOTE = _a.KOJI_UPSTREAM_REMOTE, KOJI_GIT_USERNAME = _a.KOJI_GIT_USERNAME, KOJI_GIT_TOKEN = _a.KOJI_GIT_TOKEN;
if (KOJI_ORIGIN_REMOTE && KOJI_UPSTREAM_REMOTE && KOJI_GIT_USERNAME && KOJI_GIT_TOKEN) {
    var repoInit = child_process_1.spawn('bash', [
        '/usr/src/app/.remy/scripts/addRemotes.sh',
        KOJI_GIT_USERNAME,
        KOJI_GIT_TOKEN,
        KOJI_ORIGIN_REMOTE,
        KOJI_UPSTREAM_REMOTE,
    ]);
    if (repoInit.stdout) {
