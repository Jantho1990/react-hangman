...
var Base64File = /** @class */ (function (_super) {
    ...
    Base64File.prototype.open = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stat;
            var _this = this;
            return __generator(this, function (_a) {
                this.editorType = OutboundMessage_1.EditorType.BINARY;
                ...
                fs.readFile(this.projectPath + "/" + this.path, { encoding: 'base64' }, function (err, data) {
                    if (!err) {
                        _this.body = data;
