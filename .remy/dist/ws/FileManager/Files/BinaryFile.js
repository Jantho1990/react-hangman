...
var BinaryFile = /** @class */ (function (_super) {
    __extends(BinaryFile, _super);
    function BinaryFile() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BinaryFile.prototype.open = function (editorType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                fs.readFile(this.projectPath + "/" + this.path, { encoding: 'binary' }, function (err, data) {
                    if (!err) {
                        _this.body = data;
