...
var File = /** @class */ (function (_super) {
    ...
    Object.defineProperty(File.prototype, "realPath", {
        get: function () {
    ...
    File.prototype.open = function (editorType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                stat = fs.statSync(this.projectPath + "/" + this.realPath);
                if (stat.size > 5e6) {
                    // File is larger than 5 mb, skip!
                    console.log('Skipping giant file', stat.size);
                    return [2 /*return*/];
                }
                fs.readFile(this.projectPath + "/" + this.realPath, { encoding: 'utf8' }, function (err, data) {
                    if (!err) {
                        _this.body = data;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        fs.writeFile(_this.projectPath + "/" + _this.realPath, _this.body, function (err) {
                            resolve();
                        });
                    })];
            });
