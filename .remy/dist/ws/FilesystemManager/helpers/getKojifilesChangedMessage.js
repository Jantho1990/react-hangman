...
function getKojifilesChangedMessage() {
    return __awaiter(this, void 0, void 0, function () {
        var paths, filteredPaths, projectConfig, protocol, serverId, hostname, proxyHost;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (process.env.KOJI_PROXY_HOST) {
                        proxyHost = JSON.parse(process.env.KOJI_PROXY_HOST);
                                ...
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        Object.keys(configFile_1).forEach(function (key) {
                                            ...
                                            if (key === 'develop') {
                                                try {
                                                    projectConfig.services = Object.keys(configFile_1.develop).map(function (key) { return ({
                                                        name: key,
                                                        frameUrl: "" + protocol + configFile_1.develop[key].port + "-" + serverId + "--inline." + hostname,
                                                        rawUrl: "" + protocol + configFile_1.develop[key].port + "-" + serverId + "." + hostname,
                                                    }); });
                                                }
                                                catch (err) {
                                                    //
