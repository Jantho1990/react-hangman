...
var FilesystemManager = /** @class */ (function () {
    ...
    Object.defineProperty(FilesystemManager.prototype, "filesystemChangedMessage", {
        get: function () {
            var paths = this.files.filter(function (file) { return file; }).slice();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [4 /*yield*/, new Promise(function (resolve) {
                            fs.writeFile(_this.projectPath + "/" + fullPath, '', function () {
                                resolve();
                            });
                        })];
                    case 3:
    ...
    FilesystemManager.prototype.upload = function (fullPath, body) {
        return __awaiter(this, void 0, void 0, function () {
            var path;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [4 /*yield*/, new Promise(function (resolve) {
                            fs.writeFile(_this.projectPath + "/" + fullPath, body, 'base64', function () {
                                resolve();
                            });
                        })];
                    case 3:
