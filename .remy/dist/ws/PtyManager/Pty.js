...
var Pty = /** @class */ (function () {
    function Pty(id, cwd, name, username, envExtras) {
        var _this = this;
        this.frames = [];
        this.onData = null;
        this.onExit = null;
        ...
        this.proc = NodePty.spawn('bash', [], {
            ...
            rows: 30,
            cwd: cwd,
            env: __assign({}, process.env, { PS1: String.raw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["[[]", "@koji]$[ ]"], ["\\[[\\]", "@koji]$\\[ \\]"])), username) }, envExtras),
        });
