...
function getDefaultPtysFromKojifiles() {
    return __awaiter(this, void 0, void 0, function () {
        var paths, filteredPaths, projectConfig, defaultPtys;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    try {
                        Object.keys(projectConfig.develop).forEach(function (key) {
                            var service = projectConfig.develop[key];
                            defaultPtys.push({
                                name: key,
                                cwd: service.path || '',
                    ...
                    return [2 /*return*/, defaultPtys];
            }
        });
    });
}
exports.getDefaultPtysFromKojifiles = getDefaultPtysFromKojifiles;
//# sourceMappingURL=getDefaultPtysFromKojifiles.js.map