...
function getEnvAliasesFromKojifiles(secretsMap) {
    return __awaiter(this, void 0, void 0, function () {
        var paths, filteredPaths, projectConfig, envAliases, _a, protocol_1, serverId_1, hostname_1;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    envAliases = {};
                    try {
                        projectConfig['@@editor'].forEach(function (section) {
                            section.fields.forEach(function (field) {
                                if (field.envAlias) {
                                    var value = projectConfig[section.key][field.key];
                                    if (secretsMap[value]) {
                    ...
                    try {
                        _a = JSON.parse(process.env.KOJI_PROXY_HOST || ''), protocol_1 = _a.protocol, serverId_1 = _a.serverId, hostname_1 = _a.hostname;
                        Object.keys(projectConfig.develop).forEach(function (key) {
                            envAliases["KOJI_SERVICE_URL_" + key] = "" + protocol_1 + projectConfig.develop[key].port + "-" + serverId_1 + "." + hostname_1;
                        });
                    }
                    catch (err) {
                        //
                    }
                    return [2 /*return*/, envAliases];
            }
        });
    });
}
exports.getEnvAliasesFromKojifiles = getEnvAliasesFromKojifiles;
//# sourceMappingURL=getEnvAliasesFromKojifiles.js.map