...
var Server = /** @class */ (function () {
    function Server(port, projectPath, creatorUsername, remoteBucketName, remoteBucketPrefix) {
        var _this = this;
        this.clients = [];
        ...
        this.systemStatusInterval = setInterval(function () { return _this.updateSystemStatus(); }, 1000 * 30); // every 30 seconds
    }
    ...
    Server.prototype.initWss = function () {
        ...
        this.wss.on('connection', function (ws, req) {
            ...
            var state = new Client_1.Client(_this, ws, _this.filesystemManager, _this.fileManager, _this.ptyManager, _this.gitManager, clientId, sessionId, userProfile, isController, color);
