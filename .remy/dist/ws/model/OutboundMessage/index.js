...
(function (OutboundMessage) {
    ...
    function getGitStatusChangedCommand(gitStatusChanged) {
        return {
            type: Type.GIT_STATUS_CHANGED,
            gitStatusChanged: gitStatusChanged,
        };
    }
    OutboundMessage.getGitStatusChangedCommand = getGitStatusChangedCommand;
    function getGitErrorCommand(gitError) {
        return {
            type: Type.GIT_ERROR,
            gitError: gitError,
        };
    }
    OutboundMessage.getGitErrorCommand = getGitErrorCommand;
    ////////////////////////////////////////////////////////////////////////////////
    // PRIVATE: Types
    var Type;
    (function (Type) {
        ...
        Type["GIT_STATUS_CHANGED"] = "git/status_changed";
        Type["GIT_ERROR"] = "git/error";
    })(Type || (Type = {}));
